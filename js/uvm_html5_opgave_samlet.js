...
var UVM = {
    ...
    *****************************************************************/
    ...
    setSidebarText: function () {
        var examTypes = {
            stx: { sidebar: '<div id="school-title">stx</div>' + '<div id="exam-title">studentereksamen</div>' },
            hhx: { sidebar: '<div id="school-title">hhx</div>' + '<div id="exam-title">højere handelseksamen</div>' },
        ...
        var fag = $("body").attr("data-fag");
        $(".sub-title").append(examTypes[fag].sidebar);
    },
};
   ...
   *****************************************************************/
    ...
    *****************************************************************/
    funcLoadMenu: function (intSelectedPageId, intSelectedPageParentId) {
        ...
        for (var i = 0; i < hooks.PageLoaded.length; i++) {
            hooks.PageLoaded[i](intSelectedPageId);
        }
    },
    ...
    *****************************************************************/
    funcLoadContent: function (intSelectedPageId, pageLayout) {
        ...
        $('.PAGE[data-id="' + intSelectedPageId + '"]  iframe[data-load]:not([src])').each(function () {
    ...
    *****************************************************************/
    funcSetActiveLinkClasses: function (intSelectedPageId, intSelectedPageParentId) {
        ...
        if (intSelectedPageParentId != 0) {
            ...
            if (document.getElementById("" + intSelectedPageId + "").setAttribute("class", "subMenu subLinkActive subMenuVisited")) {
        ...
        document.querySelectorAll('.main').forEach(element => {
            element.addEventListener('click', (e) => {
                // e.preventDefault();
                element.classList.add('subMenuVisited');
            });
        });

        // document.addEventListener('click', function handleClick(event) {
        //     event.target.classList.add('subMenuVisited');
        //     console.log("hej")
        //   });
        ...
        // document.addEventListener('click', function objPage(id) {
        //     id.target.classList.add('subMenuVisited');
        //     console.log("klik")
        // })

        // const visited = document.getElementsByClassName('data-id')
        //     console.log('clicked')

        //     for (const visit of visited) {
        //      visit.addEventListener('click', function handleClick(){
        //          visit.classList.add('subMenuVisited')
        //      });
        //     }
    },
    /*****************************************************************
